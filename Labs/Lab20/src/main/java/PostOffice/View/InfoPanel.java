...
public class InfoPanel extends JPanel {
    ...
    public InfoPanel(PostalController controller, String title, int width, int height, int margin) {
    ...
    private void createComponentsOnLeftPanel() {
        // JLabel lblNumGuest = new JLabel("Sender");
    ...
    private void createAndInitiateComBox() {
        ...
        cmbCountries.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                ...
                // controller.setCountry(obj, index);
            }
        });
    }
